...
module "cardlists_starwarsccg_org" {
  source            = "../../modules/aws-s3-website"
  s3_bucket_name    = "cardlists.starwarsccg.org"
  domain_names      = ["cardlists.starwarsccg.org"]
  ## cloudfront requicardlists that the ssl cert be in us-east-1
